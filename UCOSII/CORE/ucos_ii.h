...
#ifdef   OS_GLOBALS
#define  OS_EXT          //如果定义了OS_GLOBALS，就将OS_EXT定义为空  
#else
#define  OS_EXT  extern  //如果没有定义了OS_GLOBALS，就将OS_EXT定义为extern
#endif
...
/*
*********************************************************************************************************
*                                        OS_EVENT types  事件类型pevent->OSEventType
*********************************************************************************************************
*/
...
#define OS_ERR_PEND_ISR                 2u           //在中断中调用等待函数引起的错误
...
/*
*********************************************************************************************************
*                                     MEMORY PARTITION DATA STRUCTURES      内存分区数据结构
*********************************************************************************************************
*/
